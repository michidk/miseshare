...
- Stream audio is kept on a separate native WebRTC media track. Publishers can add it from the browser picker or stop and resume sending it without restarting the screen capture, and every receiver can mute each incoming stream independently.
